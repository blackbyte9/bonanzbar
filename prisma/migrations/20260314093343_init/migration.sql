-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'ORGANIZER', 'USER', 'GUEST', 'INACTIVE');
...
CREATE TABLE "shoppingunits" (
    ...
    CONSTRAINT "shoppingunits_pkey" PRIMARY KEY ("id")
);
